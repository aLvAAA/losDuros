...
namespace WindowsFormsApplication1.Login
{
    public partial class SeleccionRol : Form
    {
        ...
        private bool recuperarRolesHabilitados()
        {
            ...
            cmd.CommandText = "SELECT dbo.ROLXUSUARIO.ROLUSR_NOMBRE FROM dbo.ROLXUSUARIO ";
            cmd.CommandText += "JOIN dbo.ROL ON (dbo.ROL.ROL_NOMBRE = dbo.ROLXUSUARIO.ROLUSR_NOMBRE AND ROL_HABILITADO = 1) WHERE ";
