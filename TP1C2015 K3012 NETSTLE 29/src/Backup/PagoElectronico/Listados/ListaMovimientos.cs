...
namespace PagoElectronico.Listados
{
    public partial class ListaMovimientos : Form
    {
        ...
        public ListaMovimientos(SqlConnection sqlCon, String anio, String trimestre):this()
        {
            this.sqlCon = sqlCon;
        ...
        private void buscar()
        {
            ...
            conslt += "MOV_PAIS, COUNT(*) FROM NETSTLE.MOVIMIENTOSPAIS ";
            conslt += "WHERE YEAR(MOV_FECHA) = '" + textBox1.Text + "' AND MONTH(MOV_FECHA) IN ('" + mes1 + "', '" + mes2 + "', '" + mes3 + "') ";
            conslt += "GROUP BY MOV_PAIS ";
            ...
            dataGridView.Columns[0].HeaderText = "Nombre del país.";
            dataGridView.Columns[1].HeaderText = "Cantidad de movimientos (ingresos y egresos).";
        }
